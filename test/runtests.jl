...
@testset "DrillHoles.jl" begin
  @testset "desurvey" begin
    ...
    @test isapprox(dh.X, [1.000152273918042, 1.0006852326311886, 1.001751150057482, 2.180003148116409, 2.466371792847059, 2.6136470958513938], atol=1e-5)
    @test isapprox(dh.Y, [1.0130869793585429, 1.058891407113443, 1.1505002626232426, 2.4809751054874134, 3.2461627733082983, 3.6396878596161817], atol=1e-5)
    @test isapprox(dh.Z, [0.5001776737812189, -1.2492004679845148, -4.747956751515982, -0.1391896286156471, -3.5424458559587215, -5.292691915735159], atol=1e-5)
    ...
    @test isapprox(dh2.Z, [0.5000761524218044, -1.2496573141018803, -4.74912424714925, -0.1436141425275177, -3.553909369275841, -5.307775485889264], atol=1e-5)
